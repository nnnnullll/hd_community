...
public interface PartnerMapper {
    ...
    //插partner
    @Update("update `partner` set `partner`.name = #{partner.name},  `partner`.address = #{partner.address},`partner`.phone = #{partner.phone},`partner`.email = #{partner.email},`partner`.password = #{partner.password},`partner`.description = #{partner.description},`partner`.one = #{partner.one},`partner`.two = #{partner.two},`partner`.three = #{partner.three},`partner`.four = #{partner.four},`partner`.five = #{partner.five} where `partner`.num = #{partner.num} ")
